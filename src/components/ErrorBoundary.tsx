        ...
        <div className="min-h-screen bg-stone-950 flex items-center justify-center p-4">
          ...
          >
            ...
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-2 bg-white text-stone-900 px-6 py-3.5 rounded-xl font-semibold hover:bg-stone-100 transition-colors shadow-[0_0_20px_-5px_rgba(255,255,255,0.3)]"
            >
